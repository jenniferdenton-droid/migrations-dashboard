...
Manager Capacity + Pipeline). Deploys to Vercel, sits behind Cloudflare Access SSO, pulls
from HubSpot + Google Calendar, syncs into Firestore, and posts Slack alerts on note
tagging.

**Start here:** `SETUP.md` — full step-by-step for GitHub, Vercel, Cloudflare Access,
HubSpot, Google Calendar, Slack, and Firebase, plus the exact list of open inputs still
needed before this can go live with real data.
